//#region FONT DATABASE
    const fontData = [
      ...
      { name: "Noto Sans KR", family: "'Noto Sans KR', sans-serif", category: "Sans-Serif" },
      { name: "Noto Sans SC", family: "'Noto Sans SC', sans-serif", category: "Sans-Serif" },
      { name: "Pangolin", family: "'Pangolin', sans-serif", category: "Sans-Serif" },
      { name: "Playpen Sans Hebrew", family: "'Playpen Sans Hebrew', sans-serif", category: "Sans-Serif" },
      ...
      { name: "Oleo Script", family: "'Oleo Script', cursive", category: "Cursive" },
      { name: "Pacifico", family: "'Pacifico', cursive", category: "Cursive" },
      { name: "Petit Formal Script", family: "'Petit Formal Script', cursive", category: "Cursive" },
      ...
      { name: "Sunshiney", family: "'Sunshiney', decorative", category: "Decorative"},

      { name: "DotGothic16", family: "'DotGothic16', monospace", category: "Pixel"},
      { name: "Jacquard 12", family: "'Jacquard 12', monospace", category: "Pixel"},
      { name: "Jacquard 24", family: "'Jacquard 24', monospace", category: "Pixel"},
      { name: "Silkscreen", family: "'Silkscreen', monospace", category: "Pixel"},
      { name: "Pixelify Sans", family: "'Pixelify Sans', monospace", category: "Pixel"},
      { name: "Press Start 2P", family: "'Press Start 2P', monospace", category: "Pixel"},
      { name: "VT323", family: "'VT323', monospace", category: "Pixel"},
      ...
      { name: "linefont", family: "'linefont'", category: "Do Not Use" }
    ];
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // #region LIVE TEXT INPUT LISTENERS
